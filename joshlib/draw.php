...
function draw_focus($form_element) {
	return '<script language="javascript">
		document.getElementById("' . $form_element . '").focus();
		</script>';
}
...
function draw_form_file($name, $class="file") {
...
function draw_javascript_src($src=false) {
	if (!$src) $src = "http://joshlib.joshreisner.com/javascript.js";
	return '
	<script language="javascript" src="' . $src . '" type="text/javascript"></script>
	';
}
